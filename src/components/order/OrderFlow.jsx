    ...
    switch (step) {
      ...
      case 'configure': {
        const scanProgressValue =
          scanStatus === 'clean' || scanStatus === 'malicious' || scanStatus === 'error'
            ? 100
            : scanStatus === 'pending'
              ? 60
              : 15;
              ...
              <CardContent className="space-y-6">
                ...
                <div className="rounded-lg border border-dashed p-3 bg-neutral-50">
                  ...
                  <Progress
                    ...
                    aria-label="Progreso de verificación del archivo"
                  />
                  <div className="flex justify-between text-[11px] text-neutral-500 mt-1 uppercase tracking-wide">
                    <span>Subido</span>
